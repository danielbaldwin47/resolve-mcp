"""Validate + build the piece-3 Taurus MID cut, then run the correlate self-review.

Same shape as taurus_ending_build_p2r3.py: one long-lived process, the correlate job
polled in-process. Leaves 'Zinc SYNC' current at the end (see mid_p3_render.py).
"""
...
CUT = HERE.parents[1] / "projects" / "mcp-tests-zinc" / "taurus-people-mid-p3.cut.json"
OUT = HERE / "mid_p3_build.json"
