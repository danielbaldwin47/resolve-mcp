"""Put the round-2 piece-3 timeline on 1080p custom settings, render it, restore Zinc SYNC.
...
result = {{'before': before, 'ok_w': ok_w, 'ok_h': ok_h,
           ...
           'items': len(found.GetItemListInTrack('video', 1) or [])}}
"""
