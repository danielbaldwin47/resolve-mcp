"""Set the song anchor on the round-3 timeline, then leave Zinc SYNC current.

Titles are positioned as offsets from a blue marker named for the song key
(titles/schema.py sec 2), so the anchor sits on frame 0 of the piece - the first
frame of the title card.
"""
        ...
        markers=[
            {
                ...
                "color": "Blue",
                "name": "taurus-people",
                "note": "Song anchor for taurus-people.titles.json (card at +0, personnel at +495).",
            }
        ],
    )
