"""Validate + build the round-3 Taurus opening cut, then run the correlate self-review.
...
def main() -> None:
    ...
    print("SUMMARY:", json.dumps(keep, indent=1, default=str)[:2500], flush=True)
